        ...
        <div className='billboard'>
            <Container fluid>
                ...
                <ButtonGroup>
                    ...
                    <Button active outline color="success" href="/billboard/comedy">Comedy</Button>{' '}
                    ...
                    <Table hover responsive size="sm">
                        ...
                        <tbody>
                            {booklists.filter(booklist => booklist.genres === "Comedy").sort(function(a,b){return b.score-a.score}).slice(0,10)
                            .map(booklist => {
